...
import app.service.ChequeLineService;
...
public class DAOTest {
    ...
    public DAOTest() {
        ...
        chequeLineDAO = new ChequeLineDAOImpl();
    }
    ...
    private void fill() throws SQLException {
        try(Connection con = ConnectionPool.getInstance().getConnection();
            ...
            stmt.addBatch("INSERT INTO cheques (id, price, state, creationTime) VALUES (1, 0, 1, DATE '2021-12-12'), (2, 0, 1, DATE '2019-09-14'), (3, 0, 1, DATE '2020-03-09'), (4, 0, 1, DATE '2021-07-22'), (5, 0, 1, DATE '2018-09-21'), (6, 0, 1, DATE '2021-01-16'), (7, 0, 1, DATE '2021-03-18'), (8, 0, 1, DATE '2020-10-08'), (9, 0, 1, DATE '2021-11-11'), (10, 0, 1, DATE '2017-08-12'), (11, 0, 1, DATE '2019-09-27'), (12, 0, 1, DATE '2017-11-22');");
        ...
        ChequeLineDAO chequeLineDAO = new ChequeLineDAOImpl();
